...
class sensor_test(unittest.TestCase):
	...
	def test_operate_irrigation(self):
		...
		self.sensors.add_device(dev_cfg)
		dev_cfg["name"] = "drippers_2"
		self.sensors.add_device(dev_cfg) # I add it again but with a different name
		...
		drippers_states = [self.sensors.get_dev_state("drippers_1"), self.sensors.get_dev_state("drippers_2")]
		self.assertEqual(drippers_states[0][0], True)
		self.assertEqual(drippers_states[0][2], 1)
		self.assertEqual(drippers_states[1][0], True)
		self.assertEqual(drippers_states[1][2], 1)

		# I force one dripper to finish
		...
		drippers_states = [self.sensors.get_dev_state("drippers_1"), self.sensors.get_dev_state("drippers_2")]
		self.assertEqual(drippers_states[0][0], False)
		self.assertEqual(drippers_states[0][2], 0)
		self.assertEqual(drippers_states[1][0], False)
		self.assertEqual(drippers_states[1][2], 0)
